...
class Path:
    ...
    def dirname(self) -> str:
        """The directory name of the data file."""
    ...
    def file_number(self) -> int:
        """The file number of the data file."""
    ...
    def image_number(self) -> int:
        ...
        if image_number == 0:
            ...
            image_result_path = os.path.join(image_number_directory, self.IMAGE_FILENAME)
    ...
    def roi_number(self) -> int:
        ...
        if roi_number == 0:
            ...
            roi_number -= 1
            roi_number_directory = os.path.join(
                self.roi_directory, f"{roi_number}"
            )
            roi_result_path = os.path.join(roi_number_directory, self.ROI_IMAGE_FILENAME)
            roi_change_path = os.path.join(roi_number_directory, self.ROI_CHANGE_FILENAME)
